...
export default {
  name: 'UserEdit',
  // props true в роутере, чтобы при открытии страницы входными параметрами пришел id
  props: {
  ...
  mounted() {
    ...
    // если в query передавали параметр, к нему можно получить доступ
    // this.$route.query.test см. dev tools
  },
};
</script>
